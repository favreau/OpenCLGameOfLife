...
public:
  ...
  void compileKernels(const KernelSourceType sourceType,
                      const std::string &source, const std::string &ptxFileName,
                      const std::string &options);

public:
  // ---------- Rendering ----------
  void render(int imageW, int imageH, BYTE *bitmap, float value);
...
public:
  ...
  long updateSkeletons(double center_x, double center_y, double center_z,
